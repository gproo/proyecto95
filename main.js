...
function my_keydown(e)
{
    ...
    //Completa el código para la función "down()" 
	function down()
	{
		if(ball_x <=450)
		{
			ball_y = ball_y + block_image_height;
			console.log("alto de la imagen del bloque = " + block_image_width);
			console.log("Cuando se presione la tecla abajo, X = " + ball_x + " , Y = "+bll_y);
			canvas.remove(ball_obj);
			new_image();
		}
    ...
    //Completa el código para la función "right()" 
	function right()
	{
		if(ball_x <=1050)
		{
			ball_x = ball_x + block_image_width;
			console.log("ancho de la imagen del bloque = " + block_image_width);
			console.log("Cuando se presione la tecla derecha, X = " + ball_x + " , Y = "+bll_y);
			canvas.remove(ball_obj);
			new_image();
		}
